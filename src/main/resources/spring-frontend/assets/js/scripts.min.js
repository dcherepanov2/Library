    ...
    $(function () {
        ...
        var Login = function () {
            ...
            function postData(address, data, cb, cbErr) {
                ...
                // ver header = $('#_csrf_header').attr('content');
                ...
                init: function () {
                    $('.Transactions-get').on('click', function (e) {
                        ...
                        getData('/api/transactions', {
                            ...
                            offset: function() {
                                var oldOffset = Math.abs($this.data('transactionoffset'));
                                if(oldOffset < 1) {
                                    $this.data('transactionoffset', ++oldOffset);
                                } else {
                                    $this.data('transactionoffset', ++oldOffset - $this.data('transactionlimit'));
                                }
                                return $this.data('transactionoffset');
                            },
                            //$this.data('transactionoffset'),
