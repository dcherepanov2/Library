...
INSERT INTO book_file SELECT 1, '123', 1, 0.00, 'file.epub', 1 WHERE NOT EXISTS(SELECT id FROM book_file WHERE id = 1);
INSERT INTO file_download SELECT 1,1,1,1 WHERE NOT EXISTS(SELECT id FROM file_download WHERE id = 1);
INSERT INTO book_file SELECT 2, '1234', 2, 0.00, 'file.fb2', 1 WHERE NOT EXISTS(SELECT id FROM book_file WHERE id = 2);
INSERT INTO book_file SELECT 3, '12345', 3, 0.00, 'file.pdf', 1 WHERE NOT EXISTS(SELECT id FROM book_file WHERE id = 3);
INSERT INTO file_download SELECT 2,1,1,1 WHERE NOT EXISTS(SELECT id FROM file_download WHERE id = 2);
INSERT INTO book2file SELECT 1, 1, 1 WHERE NOT EXISTS(SELECT id FROM book2file WHERE id = 1);
INSERT INTO book2file SELECT 2, 1, 1 WHERE NOT EXISTS(SELECT id FROM book2file WHERE id = 2);
INSERT INTO book2file SELECT 3, 1, 1 WHERE NOT EXISTS(SELECT id FROM book2file WHERE id = 3);